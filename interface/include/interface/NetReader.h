...
namespace interface {
    ...
    public:
         ...
         */
        NetReader(const std::string &_name, bool _activate_bias_and_out_act, int _batch, int _epoch, bool _TENSORFLOW_8b) :
                activate_bias_and_out_act(_activate_bias_and_out_act), batch(_batch), epoch(_epoch), 
