...
namespace core {
    ...
    private:
         ...
         */
        PE_stats computeSCNNePE(int W, int H, int stride, const act_idxMap &act, const wgt_idxMap &wgt);
    ...
    public:
         ...
         */
        SCNNe(int _Wt, int _Ht, int _I, int _F, int _out_acc_size, int _BANKS, int _PE_SERIAL_BITS, uint8_t _N_THREADS,
