...
namespace core {
    ...
    public:
        ...
        /**
         * Return the number physical columns per window
         * @return Physical columns per window
         */
        uint32_t getActBlks() const;

        /**
         * Return the number physical rows per filter
         * @return Physical rows per filter
         */
