...
namespace core {
    ...
    public:
        ...
        Loom(int _N_COLUMNS, int _N_ROWS, int _PRECISION_GRANULARITY, int _PE_SERIAL_BITS, bool _LEADING_BIT,
                bool _MINOR_BIT, bool _DYNAMIC_WEIGHTS, uint8_t _N_THREADS, bool _FAST_MODE) :
                ...
                LEADING_BIT(_LEADING_BIT), MINOR_BIT(_MINOR_BIT), DYNAMIC_WEIGHTS(_DYNAMIC_WEIGHTS) {}
