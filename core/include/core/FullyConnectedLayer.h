...
namespace core {
    ...
    public:
         ...
         */
        FullyConnectedLayer(const std::string &_name, const std::string &_input, uint16_t _Nn, uint16_t _Kx,
                            uint16_t _Ky, uint16_t _stride, uint16_t _padding) : Layer(_name, _input, _Nn, _Kx, _Ky,
                                                                                       _stride, _padding) {}
